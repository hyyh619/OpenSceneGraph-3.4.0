...
#define FACE_LOG(level, zone, fmt, ...)                                                   \
    ...
    {                                                                                     \
        ...
        {                                                                                 \
            if (level == FACE_ERROR && level <= LOG_LEVEL)                                \
            {                                                                             \
                __android_log_print(ANDROID_LOG_ERROR, "OSG-3.4.0", fmt, ## __VA_ARGS__); \
            }                                                                             \
            if (level == FACE_WARNING && level <= LOG_LEVEL)                              \
            {                                                                             \
                __android_log_print(ANDROID_LOG_WARN, "OSG-3.4.0", fmt, ## __VA_ARGS__);  \
            }                                                                             \
            if (level == FACE_INFO && level <= LOG_LEVEL)                                 \
            {                                                                             \
                __android_log_print(ANDROID_LOG_INFO, "OSG-3.4.0", fmt, ## __VA_ARGS__);  \
            }                                                                             \
            if (level == FACE_DEBUG && level <= LOG_LEVEL)                                \
            {                                                                             \
                __android_log_print(ANDROID_LOG_DEBUG, "OSG-3.4.0", fmt, ## __VA_ARGS__); \
            }                                                                             \
        }                                                                                 \
    } while (0)
