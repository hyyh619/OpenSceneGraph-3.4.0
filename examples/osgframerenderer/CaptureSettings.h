...
void setOutputImageFlip(bool flip)
{
    _outputImageFlip = flip;
}
bool getOutputImageFlip() const
{
...
void setSampleBuffers(unsigned int s)
{
    _sampleBuffers = s;
}
unsigned int getSampleBuffers() const
{
...
void setNumberOfFrames(unsigned int nf)
{
    _numberOfFrames = nf;
}
