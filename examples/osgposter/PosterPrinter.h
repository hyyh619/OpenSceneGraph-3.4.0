...
unsigned int getNumNames() const
{
    return _pagedNodeNames.size();
}

PagedNodeNameSet&getPagedNodeNames()
{
    return _pagedNodeNames;
}
const PagedNodeNameSet&getPagedNodeNames() const
{
    return _pagedNodeNames;
}

unsigned int getNeedToApplyCount() const
{
    return _needToApplyCount;
}
unsigned int getAppliedCount() const
{
...
void setAddingCallbacks(bool b)
{
    _addingCallbacks = b;
}
bool getAddingCallbacks() const
{
...
PosterVisitor* getPosterVisitor()
{
    return _visitor.get();
}
const PosterVisitor* getPosterVisitor() const
{
    return _visitor.get();
}
...
void setOutputTiles(bool b)
{
    _outputTiles = b;
}
bool getOutputTiles() const
{
    return _outputTiles;
}
...
const std::string&getOutputTileExtension() const
{
...
const std::string&getOutputPosterName() const
{
...
const osg::Vec2&getPosterSize() const
{
    return _posterSize;
}
...
void setFinalPoster(osg::Image *image)
{
    _finalPoster = image;
}
const osg::Image* getFinalPoster() const
{
