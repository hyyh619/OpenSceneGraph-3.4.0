...
DrawShapeVisitor&operator =(const DrawShapeVisitor&)
{
    return *this;
}
...
ComputeBoundShapeVisitor&operator =(const ComputeBoundShapeVisitor&)
{
    return *this;
}
};
...
PrimitiveShapeVisitor&operator =(const PrimitiveShapeVisitor&)
{
    return *this;
}
