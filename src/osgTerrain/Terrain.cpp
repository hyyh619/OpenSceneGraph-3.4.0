...
{
    if (_equalizeBoundaries == equalizeBoundaries)
        return;
...
void Terrain::registerTerrainTile(TerrainTile *tile)
{
    ...
    if (_terrainTileSet.size() > s_maxNumTiles)
        s_maxNumTiles = _terrainTileSet.size();
