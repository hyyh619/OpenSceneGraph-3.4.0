...
void AnimationManagerBase::setAutomaticLink(bool state)
{
    _automaticLink = state;
}
bool AnimationManagerBase::getAutomaticLink() const
{
    return _automaticLink;
}
...
bool AnimationManagerBase::needToLink() const
{
    return _needToLink && getAutomaticLink();
}
