...
osgDB::ReaderWriter::ReadResult ReaderWriterPaths::readObject(std::istream &fin, const osgDB::Options *options) const
{
    ...
    if (ext == "path")
        return read_path(fin, options);
    else if (ext == "material")
        return read_material(fin, options);
    else if (ext == "pivot_path")
        return read_pivot_path(fin, options);
    else if (ext == "rotation_path")
        return read_rotation_path(fin, options);
