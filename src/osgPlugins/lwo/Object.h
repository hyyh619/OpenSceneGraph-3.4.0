...
CoordinateSystemFixer&operator=(const CoordinateSystemFixer&)
{
    return *this;
}
};
...
LwoCoordFixer&operator=(const LwoCoordFixer&)
{
    return *this;
}
};
...
inline const CoordinateSystemFixer* get_coordinate_system_fixer() const
{
    return csf_.get();
}
inline void set_coordinate_system_fixer(CoordinateSystemFixer *csf)
{
    csf_ = csf;
}
...
inline const Layer_map&layers() const
{
    return layers_;
}

inline Surface_map&surfaces()
{
    return surfaces_;
}
inline const Surface_map&surfaces() const
{
    return surfaces_;
}
