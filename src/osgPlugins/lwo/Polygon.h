...
inline void set_invert_normal(bool v = true)
{
    invert_normal_ = v;
}

inline const Index_list&indices() const
{
    return indices_;
}
inline Index_list&indices()
{
    dirty_normal(); return indices_;
}

inline const Duplication_map&dup_vertices() const
{
    return dup_vertices_;
}
inline Duplication_map&dup_vertices()
{
    return dup_vertices_;
}

inline const VertexMap* local_normals() const
{
    return local_normals_.get();
}
inline VertexMap* local_normals()
{
    return local_normals_.get();
}
...
inline const Surface* get_surface() const
{
    return surf_;
}
inline void set_surface(const Surface *s)
{
    surf_ = s;
}
...
inline const std::string&get_part_name() const
{
    return part_;
}
...
inline bool has_smoothing_group() const
{
    return !smoothing_group_.empty();
}
inline const std::string&get_smoothing_group() const
{
