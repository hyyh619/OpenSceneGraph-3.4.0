...
VideoFrameDispatcher* getVideoFrameDispatcher() const
{
    return _dispatcher;
}
void setVideoFrameDispatcher(VideoFrameDispatcher *dispatcher)
{
    _dispatcher = dispatcher;
}
bool getNeedsDispatching() const
{
    return _needsDispatching;
}

void setDispatchQueue(VideoFrameDispatchQueue *queue)
{
    _queue = queue;
}
VideoFrameDispatchQueue* getDispatchQueue() const
{
    return _queue;
}
...
~VideoFrameDispatchQueue();
unsigned int getNumItemsInQueue() const
{
    return _numItems;
}
