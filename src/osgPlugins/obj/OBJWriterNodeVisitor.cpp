...
ValueVisitor&operator =(const ValueVisitor&)
{
    return *this;
}
...
ObjPrimitiveIndexWriter&operator =(const ObjPrimitiveIndexWriter&)
{
    return *this;
}
