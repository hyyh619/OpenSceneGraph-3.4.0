    ...
    for (;;)
    {
        ...
        else if (s.compare(1, 5, "clamp") == 0)
        {
            ...
            if (strncmp(c, "on", 2) == 0)
                ...
                map.clamp = false;     // default behavioud
        }
        else
            break;
    ...
    while (fin)
    {
        ...
        else if (strlen(line) > 0)
        {
            ...
            else if (strncmp(line, "vn ", 3) == 0)
            {
                ...
                if (fieldsRead == 1)
                    normals.push_back(osg::Vec3(x, 0.0f, 0.0f));
                else if (fieldsRead == 2)
                    normals.push_back(osg::Vec3(x, y, 0.0f));
                else if (fieldsRead == 3)
            ...
            else if (strncmp(line, "vt ", 3) == 0)
            {
                ...
                if (fieldsRead == 1)
                    texcoords.push_back(osg::Vec2(x, 0.0f));
                else if (fieldsRead == 2)
            ...
            else if (strncmp(line, "s ", 2) == 0)
            {
                ...
                if (strncmp(line + 2, "off", 3) == 0)
                    smoothingGroup = 0;
                else
                    sscanf(line + 2, "%d", &smoothingGroup);
...
{
    if (element.normalIndices.empty())
        return false;
