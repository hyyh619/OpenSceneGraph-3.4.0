...
static int readValue(osgDB::InputStream&is)
{
    ...
    else
    {
        ...
        if (enumValue.find("OFF") != std::string::npos)
            value = osg::StateAttribute::OFF;

        if (enumValue.find("ON") != std::string::npos)
            value = osg::StateAttribute::ON;

        if (enumValue.find("OVERRIDE") != std::string::npos)
            value = value | osg::StateAttribute::OVERRIDE;

        if (enumValue.find("PROTECTED") != std::string::npos)
            value = value | osg::StateAttribute::PROTECTED;

        if (enumValue.find("INHERIT") != std::string::npos)
