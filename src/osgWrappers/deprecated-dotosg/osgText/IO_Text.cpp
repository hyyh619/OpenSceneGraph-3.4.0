...
osgText::Text::BackdropType convertBackdropTypeStringToEnum(std::string&str)
{
    if (str == "DROP_SHADOW_BOTTOM_RIGHT")
        ...
        return static_cast<osgText::Text::BackdropType>(-1);
}
...
osgText::Text::BackdropImplementation convertBackdropImplementationStringToEnum(std::string&str)
{
    ...
    else if (str == "NO_DEPTH_BUFFER")
        return osgText::Text::NO_DEPTH_BUFFER;
    else if (str == "DEPTH_RANGE")
        return osgText::Text::DEPTH_RANGE;
    else if (str == "STENCIL_BUFFER")
        return osgText::Text::STENCIL_BUFFER;
    else
        return static_cast<osgText::Text::BackdropImplementation>(-1);
}
...
osgText::Text::ColorGradientMode convertColorGradientModeStringToEnum(std::string&str)
{
    ...
    else if (str == "PER_CHARACTER")
        return osgText::Text::PER_CHARACTER;
    else if (str == "OVERALL")
        return osgText::Text::OVERALL;
    else
        return static_cast<osgText::Text::ColorGradientMode>(-1);
}
