...
bool Geometry_readLocalData(Object &obj, Input &fr)
{
    ...
    if (fr.matchSequence("Primitives %i {") || fr.matchSequence("PrimitiveSets %i {"))
    {
        ...
        {
            if (!Primitive_readLocalData(fr, geom))
...
Array* Array_readLocalData(Input &fr)
{
    ...
    {
        if (!uniqueID.empty())
            fr.registerUniqueIDForObject(uniqueID.c_str(), return_array);
    }
...
bool Geometry_matchBindingTypeStr(const char *str, deprecated_osg::Geometry::AttributeBinding &mode)
{
    ...
    else if (strcmp(str, "OVERALL") == 0)
        mode = deprecated_osg::Geometry::BIND_OVERALL;
    else if (strcmp(str, "PER_PRIMITIVE") == 0)
        mode = deprecated_osg::Geometry::BIND_PER_PRIMITIVE;
    else if (strcmp(str, "PER_PRIMITIVE_SET") == 0)
        mode = deprecated_osg::Geometry::BIND_PER_PRIMITIVE_SET;
    else if (strcmp(str, "PER_VERTEX") == 0)
        mode = deprecated_osg::Geometry::BIND_PER_VERTEX;
    else
        return false;
...
bool Geometry_matchPrimitiveModeStr(const char *str, GLenum &mode)
{
    if (strcmp(str, "POINTS") == 0)
        ...
        mode = PrimitiveSet::LINES;
    else if (strcmp(str, "LINE_STRIP") == 0)
        mode = PrimitiveSet::LINE_STRIP;
    else if (strcmp(str, "LINE_LOOP") == 0)
        mode = PrimitiveSet::LINE_LOOP;
    else if (strcmp(str, "TRIANGLES") == 0)
        mode = PrimitiveSet::TRIANGLES;
    else if (strcmp(str, "TRIANGLE_STRIP") == 0)
        mode = PrimitiveSet::TRIANGLE_STRIP;
    else if (strcmp(str, "TRIANGLE_FAN") == 0)
        mode = PrimitiveSet::TRIANGLE_FAN;
    else if (strcmp(str, "QUADS") == 0)
        mode = PrimitiveSet::QUADS;
    else if (strcmp(str, "QUAD_STRIP") == 0)
        mode = PrimitiveSet::QUAD_STRIP;
    else if (strcmp(str, "POLYGON") == 0)
        mode = PrimitiveSet::POLYGON;
    else if (strcmp(str, "LINES_ADJACENCY") == 0)
        mode = PrimitiveSet::LINES_ADJACENCY;
    else if (strcmp(str, "LINE_STRIP_ADJACENCY") == 0)
        mode = PrimitiveSet::LINE_STRIP_ADJACENCY;
    else if (strcmp(str, "TRIANGLES_ADJACENCY") == 0)
        mode = PrimitiveSet::TRIANGLES_ADJACENCY;
    else if (strcmp(str, "TRIANGLE_STRIP_ADJECENCY") == 0)
        mode = PrimitiveSet::TRIANGLE_STRIP_ADJACENCY;
    else if (strcmp(str, "TRIANGLE_STRIP_ADJACENCY") == 0)
        mode = PrimitiveSet::TRIANGLE_STRIP_ADJACENCY;
    else if (strcmp(str, "PATCHES") == 0)
        mode = PrimitiveSet::PATCHES;
    else
        return false;
