...
bool Camera_readLocalData(Object&obj, Input&fr)
{
    ...
    {
        if (fr[1].matchWord("PRE_MULTIPLY"))
            camera.setTransformOrder(osg::Camera::PRE_MULTIPLY);
        else if (fr[1].matchWord("POST_MULTIPLY"))
            camera.setTransformOrder(osg::Camera::POST_MULTIPLY);
        // the following are for backwards compatibility.
        else if (fr[1].matchWord("PRE_MULTIPLE"))
            camera.setTransformOrder(osg::Camera::PRE_MULTIPLY);
        else if (fr[1].matchWord("POST_MULTIPLE"))
            camera.setTransformOrder(osg::Camera::POST_MULTIPLY);
    ...
    {
        if (fr[1].matchWord("PRE_RENDER"))
            camera.setRenderOrder(osg::Camera::PRE_RENDER);
        else if (fr[1].matchWord("NESTED_RENDER"))
            camera.setRenderOrder(osg::Camera::NESTED_RENDER);
        else if (fr[1].matchWord("POST_RENDER"))
    ...
    if (fr.matchSequence("renderTargetImplementation %w"))
    {
        ...
        if (fr[1].matchWord("FRAME_BUFFER_OBJECT"))
            implementation = osg::Camera::FRAME_BUFFER_OBJECT;
        else if (fr[1].matchWord("PIXEL_BUFFER_RTT"))
            implementation = osg::Camera::PIXEL_BUFFER_RTT;
        else if (fr[1].matchWord("PIXEL_BUFFER"))
            implementation = osg::Camera::PIXEL_BUFFER;
        else if (fr[1].matchWord("FRAME_BUFFER"))
            implementation = osg::Camera::FRAME_BUFFER;
        else if (fr[1].matchWord("SEPARATE_WINDOW"))
            implementation = osg::Camera::SEPARATE_WINDOW;
    ...
    if (fr.matchSequence("renderTargetImplementation %w"))
    {
        ...
        if (fr[1].matchWord("FRAME_BUFFER_OBJECT"))
            fallback = osg::Camera::FRAME_BUFFER_OBJECT;
        else if (fr[1].matchWord("PIXEL_BUFFER_RTT"))
            fallback = osg::Camera::PIXEL_BUFFER_RTT;
        else if (fr[1].matchWord("PIXEL_BUFFER"))
            fallback = osg::Camera::PIXEL_BUFFER;
        else if (fr[1].matchWord("FRAME_BUFFER"))
            fallback = osg::Camera::FRAME_BUFFER;
        else if (fr[1].matchWord("SEPARATE_WINDOW"))
            fallback = osg::Camera::SEPARATE_WINDOW;
...
bool Camera_matchBufferComponentStr(const char *str, Camera::BufferComponent&buffer)
{
    ...
    else if (strcmp(str, "STENCIL_BUFFER") == 0)
        buffer = osg::Camera::STENCIL_BUFFER;
    else if (strcmp(str, "PACKED_DEPTH_STENCIL_BUFFER") == 0)
        buffer = osg::Camera::PACKED_DEPTH_STENCIL_BUFFER;
    else if (strcmp(str, "COLOR_BUFFER") == 0)
        buffer = osg::Camera::COLOR_BUFFER;
    else if (strcmp(str, "COLOR_BUFFER0") == 0)
        buffer = osg::Camera::COLOR_BUFFER0;
    else if (strcmp(str, "COLOR_BUFFER1") == 0)
        buffer = osg::Camera::COLOR_BUFFER1;
    else if (strcmp(str, "COLOR_BUFFER2") == 0)
        buffer = osg::Camera::COLOR_BUFFER2;
    else if (strcmp(str, "COLOR_BUFFER3") == 0)
        buffer = osg::Camera::COLOR_BUFFER3;
    else if (strcmp(str, "COLOR_BUFFER4") == 0)
        buffer = osg::Camera::COLOR_BUFFER4;
    else if (strcmp(str, "COLOR_BUFFER5") == 0)
        buffer = osg::Camera::COLOR_BUFFER5;
    else if (strcmp(str, "COLOR_BUFFER6") == 0)
        buffer = osg::Camera::COLOR_BUFFER6;
    else if (strcmp(str, "COLOR_BUFFER7") == 0)
        buffer = osg::Camera::COLOR_BUFFER7;
    else if (strcmp(str, "COLOR_BUFFER8") == 0)
        buffer = osg::Camera::COLOR_BUFFER8;
    else if (strcmp(str, "COLOR_BUFFER9") == 0)
        buffer = osg::Camera::COLOR_BUFFER9;
    else if (strcmp(str, "COLOR_BUFFER10") == 0)
        buffer = osg::Camera::COLOR_BUFFER10;
    else if (strcmp(str, "COLOR_BUFFER11") == 0)
        buffer = osg::Camera::COLOR_BUFFER11;
    else if (strcmp(str, "COLOR_BUFFER12") == 0)
        buffer = osg::Camera::COLOR_BUFFER12;
    else if (strcmp(str, "COLOR_BUFFER13") == 0)
        buffer = osg::Camera::COLOR_BUFFER13;
    else if (strcmp(str, "COLOR_BUFFER14") == 0)
        buffer = osg::Camera::COLOR_BUFFER14;
    else if (strcmp(str, "COLOR_BUFFER15") == 0)
        buffer = osg::Camera::COLOR_BUFFER15;
    else
        return false;
