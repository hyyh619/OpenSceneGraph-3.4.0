...
bool Texture_writeLocalData(const Object &obj, Output &fw)
{
    ...
    if (texture.getInternalFormatMode() == Texture::USE_USER_DEFINED_FORMAT)
    {
        ...
        if (str)
            fw.indent() << "internalFormat " << str << std::endl;
        else
            fw.indent() << "internalFormat " << texture.getInternalFormat() << std::endl;
    }
    ...
    if (texture.getSourceFormat())
    {
        ...
        if (str)
            fw.indent() << "sourceFormat " << str << std::endl;
        else
            fw.indent() << "sourceFormat " << texture.getSourceFormat() << std::endl;
    }
    ...
    if (texture.getSourceType())
    {
        ...
        if (str)
            fw.indent() << "sourceType " << str << std::endl;
        else
            fw.indent() << "sourceType " << texture.getSourceType() << std::endl;
    }
...
bool Texture_matchWrapStr(const char *str, Texture::WrapMode &wrap)
{
    if (strcmp(str, "CLAMP") == 0)
        wrap = Texture::CLAMP;
    else if (strcmp(str, "CLAMP_TO_EDGE") == 0)
        wrap = Texture::CLAMP_TO_EDGE;
    else if (strcmp(str, "CLAMP_TO_BORDER") == 0)
        wrap = Texture::CLAMP_TO_BORDER;
...
bool Texture_matchFilterStr(const char *str, Texture::FilterMode &filter)
{
    if (strcmp(str, "NEAREST") == 0)
        ...
        filter = Texture::NEAREST_MIPMAP_NEAREST;
    else if (strcmp(str, "LINEAR_MIPMAP_NEAREST") == 0)
        filter = Texture::LINEAR_MIPMAP_NEAREST;
    else if (strcmp(str, "NEAREST_MIPMAP_LINEAR") == 0)
        filter = Texture::NEAREST_MIPMAP_LINEAR;
    else if (strcmp(str, "LINEAR_MIPMAP_LINEAR") == 0)
        filter = Texture::LINEAR_MIPMAP_LINEAR;
    else if (strcmp(str, "ANISOTROPIC") == 0)
        filter = Texture::LINEAR;
    else
        return false;
...
bool Texture_matchInternalFormatModeStr(const char *str, Texture::InternalFormatMode &mode)
{
    ...
    else if (strcmp(str, "USE_USER_DEFINED_FORMAT") == 0)
        mode = Texture::USE_USER_DEFINED_FORMAT;
    else if (strcmp(str, "USE_ARB_COMPRESSION") == 0)
        mode = Texture::USE_ARB_COMPRESSION;
    else if (strcmp(str, "USE_S3TC_DXT1_COMPRESSION") == 0)
        mode = Texture::USE_S3TC_DXT1_COMPRESSION;
    else if (strcmp(str, "USE_S3TC_DXT3_COMPRESSION") == 0)
        mode = Texture::USE_S3TC_DXT3_COMPRESSION;
    else if (strcmp(str, "USE_S3TC_DXT5_COMPRESSION") == 0)
        mode = Texture::USE_S3TC_DXT5_COMPRESSION;
    else if (strcmp(str, "USE_PVRTC_2BPP_COMPRESSION") == 0)
        mode = Texture::USE_PVRTC_2BPP_COMPRESSION;
    else if (strcmp(str, "USE_PVRTC_4BPP_COMPRESSION") == 0)
        mode = Texture::USE_PVRTC_4BPP_COMPRESSION;
    else if (strcmp(str, "USE_ETC_COMPRESSION") == 0)
        mode = Texture::USE_ETC_COMPRESSION;
    else if (strcmp(str, "USE_RGTC1_COMPRESSION") == 0)
        mode = Texture::USE_RGTC1_COMPRESSION;
    else if (strcmp(str, "USE_RGTC2_COMPRESSION") == 0)
        mode = Texture::USE_RGTC2_COMPRESSION;
    else if (strcmp(str, "USE_S3TC_DXT1c_COMPRESSION") == 0)
        mode = Texture::USE_S3TC_DXT1c_COMPRESSION;
    else if (strcmp(str, "USE_S3TC_DXT1a_COMPRESSION") == 0)
        mode = Texture::USE_S3TC_DXT1a_COMPRESSION;
    else if (strcmp(str, "USE_ETC2_COMPRESSION") == 0)
        mode = Texture::USE_ETC2_COMPRESSION;
    else
        return false;
...
bool Texture_matchInternalFormatStr(const char *str, int &value)
{
    if (strcmp(str, "GL_INTENSITY") == 0)
        value = GL_INTENSITY;
    else if (strcmp(str, "GL_LUMINANCE") == 0)
        value = GL_LUMINANCE;
    else if (strcmp(str, "GL_ALPHA") == 0)
        value = GL_ALPHA;
    else if (strcmp(str, "GL_LUMINANCE_ALPHA") == 0)
        value = GL_LUMINANCE_ALPHA;
    else if (strcmp(str, "GL_RGB") == 0)
        value = GL_RGB;
    else if (strcmp(str, "GL_RGBA") == 0)
        value = GL_RGBA;
    else if (strcmp(str, "GL_COMPRESSED_ALPHA_ARB") == 0)
        value = GL_COMPRESSED_ALPHA_ARB;
    else if (strcmp(str, "GL_COMPRESSED_LUMINANCE_ARB") == 0)
        value = GL_COMPRESSED_LUMINANCE_ARB;
    else if (strcmp(str, "GL_COMPRESSED_INTENSITY_ARB") == 0)
        value = GL_COMPRESSED_INTENSITY_ARB;
    else if (strcmp(str, "GL_COMPRESSED_LUMINANCE_ALPHA_ARB") == 0)
        value = GL_COMPRESSED_LUMINANCE_ALPHA_ARB;
    else if (strcmp(str, "GL_COMPRESSED_RGB_ARB") == 0)
        value = GL_COMPRESSED_RGB_ARB;
    else if (strcmp(str, "GL_COMPRESSED_RGBA_ARB") == 0)
        value = GL_COMPRESSED_RGBA_ARB;
    else if (strcmp(str, "GL_COMPRESSED_RGB_S3TC_DXT1_EXT") == 0)
        value = GL_COMPRESSED_RGB_S3TC_DXT1_EXT;
    else if (strcmp(str, "GL_COMPRESSED_RGBA_S3TC_DXT1_EXT") == 0)
        value = GL_COMPRESSED_RGBA_S3TC_DXT1_EXT;
    else if (strcmp(str, "GL_COMPRESSED_RGBA_S3TC_DXT3_EXT") == 0)
        value = GL_COMPRESSED_RGBA_S3TC_DXT3_EXT;
    else if (strcmp(str, "GL_COMPRESSED_RGBA_S3TC_DXT5_EXT") == 0)
...
bool Texture_matchSourceTypeStr(const char *str, int &value)
{
    if (strcmp(str, "GL_BYTE") == 0)
        value = GL_BYTE;
    else if (strcmp(str, "GL_SHORT") == 0)
        value = GL_SHORT;
    else if (strcmp(str, "GL_INT") == 0)
        value = GL_INT;
    else if (strcmp(str, "GL_UNSIGNED_BYTE") == 0)
        value = GL_UNSIGNED_BYTE;
    else if (strcmp(str, "GL_UNSIGNED_SHORT") == 0)
        value = GL_UNSIGNED_SHORT;
    else if (strcmp(str, "GL_UNSIGNED_INT") == 0)
        value = GL_UNSIGNED_INT;
    else if (strcmp(str, "GL_FLOAT") == 0)
        value = GL_FLOAT;
    else
    {
        osgDB::Field::FieldType type = osgDB::Field::calculateFieldType(str);
...
bool Texture_matchShadowCompareFuncStr(const char *str, Texture::ShadowCompareFunc &value)
{
    if (strcmp(str, "GL_NEVER") == 0)
        value = Texture::NEVER;
    else if (strcmp(str, "GL_LESS") == 0)
        value = Texture::LESS;
    else if (strcmp(str, "GL_EQUAL") == 0)
        value = Texture::EQUAL;
    else if (strcmp(str, "GL_LEQUAL") == 0)
        value = Texture::LEQUAL;
    else if (strcmp(str, "GL_GREATER") == 0)
        value = Texture::GREATER;
    else if (strcmp(str, "GL_NOTEQUAL") == 0)
        value = Texture::NOTEQUAL;
    else if (strcmp(str, "GL_GEQUAL") == 0)
        value = Texture::GEQUAL;
    else if (strcmp(str, "GL_ALWAYS") == 0)
        value = Texture::ALWAYS;
    else
        return false;
...
bool Texture_matchShadowTextureModeStr(const char *str, Texture::ShadowTextureMode &value)
{
    ...
    else if (strcmp(str, "GL_INTENSITY") == 0)
