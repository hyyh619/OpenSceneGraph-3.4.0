...
bool Stencil_readLocalData(Object &obj, Input &fr)
{
    ...
    if (setFunction)
        stencil.setFunction(func, ref, mask);
    ...
    if (setOperation)
        stencil.setOperation(sfail, zfail, zpass);
...
bool Stencil_matchFuncStr(const char *str, Stencil::Function &func)
{
    if (strcmp(str, "NEVER") == 0)
        ...
        func = Stencil::EQUAL;
    else if (strcmp(str, "LEQUAL") == 0)
        func = Stencil::LEQUAL;
    else if (strcmp(str, "GREATER") == 0)
        func = Stencil::GREATER;
    else if (strcmp(str, "NOTEQUAL") == 0)
        func = Stencil::NOTEQUAL;
    else if (strcmp(str, "GEQUAL") == 0)
        func = Stencil::GEQUAL;
...
bool Stencil_matchOperationStr(const char *str, Stencil::Operation &op)
{
    if (strcmp(str, "KEEP") == 0)
        ...
        op = Stencil::INCR;
    else if (strcmp(str, "DECR") == 0)
        op = Stencil::DECR;
    else if (strcmp(str, "INVERT") == 0)
        op = Stencil::INVERT;
    else if (strcmp(str, "INCR_WRAP") == 0)
        op = Stencil::INCR_WRAP;
    else if (strcmp(str, "DECR_WRAP") == 0)
        op = Stencil::DECR_WRAP;
    else
        return false;
