...
SWIGINTERN PyObject* _wrap_GetArrayFilename(PyObject*SWIGUNUSEDPARM(self), PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, (char*)"O:GetArrayFilename", &obj0))
        SWIG_fail;
...
SWIGINTERN PyObject* _wrap_BandRasterIONumPy(PyObject*SWIGUNUSEDPARM(self), PyObject *args, PyObject *kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, (char*)"OOOOOOOO:BandRasterIONumPy", kwnames, &obj0, &obj1, &obj2, &obj3, &obj4, &obj5, &obj6, &obj7))
        SWIG_fail;
...
static swig_cast_info _swigc__p_PyArrayObject[] =
{
    {&_swigt__p_PyArrayObject, 0, 0, 0}, {0, 0, 0, 0}
};
