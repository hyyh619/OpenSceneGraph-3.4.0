...
static void osr_destroy_globals(zend_osr_globals *globals)
{
    (void)globals;
}
...
static swig_cast_info _swigc__double[] =
{
    {&_swigt__double, 0, 0, 0}, {0, 0, 0, 0}
};
...
static void __wrap_delete_SpatialReference(zend_rsrc_list_entry *rsrc, const char*type_name TSRMLS_DC)
{
    ...
    if (!arg1)
        zend_error(E_ERROR, "OSRSpatialReferenceShadow resource already free'd");
...
static void __wrap_delete_CoordinateTransformation(zend_rsrc_list_entry *rsrc, const char*type_name TSRMLS_DC)
{
    ...
    if (!arg1)
        zend_error(E_ERROR, "OSRCoordinateTransformationShadow resource already free'd");
