...
static void ogr_destroy_globals(zend_ogr_globals *globals)
{
    (void)globals;
}
...
static swig_cast_info _swigc__int[] =
{
    {&_swigt__int, 0, 0, 0}, {0, 0, 0, 0}
};
...
static swig_cast_info _swigc__p_p_OGRGeometryShadow[] =
{
    {&_swigt__p_p_OGRGeometryShadow, 0, 0, 0}, {0, 0, 0, 0}
};
static swig_cast_info _swigc__p_p_OGRLayerShadow[] =
{
    {&_swigt__p_p_OGRLayerShadow, 0, 0, 0}, {0, 0, 0, 0}
};
...
static swig_cast_info _swigc__p_p_p_char[] =
{
    {&_swigt__p_p_p_char, 0, 0, 0}, {0, 0, 0, 0}
};
...
static void __wrap_delete_DataSource(zend_rsrc_list_entry *rsrc, const char*type_name TSRMLS_DC)
{
    ...
    if (!arg1)
        zend_error(E_ERROR, "OGRDataSourceShadow resource already free'd");
...
static void __wrap_delete_Feature(zend_rsrc_list_entry *rsrc, const char*type_name TSRMLS_DC)
{
    ...
    if (!arg1)
        zend_error(E_ERROR, "OGRFeatureShadow resource already free'd");
...
static void __wrap_delete_FeatureDefn(zend_rsrc_list_entry *rsrc, const char*type_name TSRMLS_DC)
{
    ...
    if (!arg1)
        zend_error(E_ERROR, "OGRFeatureDefnShadow resource already free'd");
...
static void __wrap_delete_FieldDefn(zend_rsrc_list_entry *rsrc, const char*type_name TSRMLS_DC)
{
    ...
    if (!arg1)
        zend_error(E_ERROR, "OGRFieldDefnShadow resource already free'd");
...
static void __wrap_delete_Geometry(zend_rsrc_list_entry *rsrc, const char*type_name TSRMLS_DC)
{
    ...
    if (!arg1)
        zend_error(E_ERROR, "OGRGeometryShadow resource already free'd");
